...
import { ConfigSheetData, ListItem, SectionConfig } from 'src/app/styleguide';
...
@Component({
  selector: 'lib-config-sheet',
  templateUrl: './config-sheet.component.html',
  styleUrls: ['./config-sheet.component.scss']
})
export class ConfigSheetComponent implements OnInit {
  ...
  constructor(
    @Inject(MAT_BOTTOM_SHEET_DATA) private sheetData: ConfigSheetData,
    @Inject(SECTION_CONFIG) private sectionConfig: SectionConfig,
    private sheetRef: MatBottomSheetRef<ConfigSheetComponent>,
